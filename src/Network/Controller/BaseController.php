...
class BaseController
{
  ...
  protected function after()
  {
    ...
    final protected function view($params,$data = [])
    {
          if(is_array($params)){
            if(count($params)==2){
              ...
              $file2="App/templates/".$params[1].".php";
              if (is_readable($file) && is_readable($file2)) {
                require_once $file2;
                $this->getHeader();
                  require_once $file;
                    $this->getFooter();
    ...
    public function getHeader(){
      if(is_readable("App/templates/".$this->header.".php")){
        return require "App/templates/".$this->header.".php";
      }
    }
    public function getFooter(){
      if(is_readable("App/templates/".$this->footer.".php")){
